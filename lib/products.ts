...
export const PRODUCTS: Product[] = [
  ...
  // ===== LITHIUM CELLS =====
  {
    ...
    description:
      "Genuine EVE Grade-A lithium iron phosphate (LiFePO4) prismatic cell — direct from EVE Energy, never grade-B. Used to build lithium batteries for solar and UPS banks; the cell behind most home solar banks in Pakistan.",
