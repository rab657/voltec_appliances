...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "vt-eve-lf100",
    name: "EVE LF100LA — 3.2V 102Ah LFP Cell",
    category: "Lithium Cells",
    categoryId: "cells",
    tech: "LFP",
    badge: "Most shipped",
    price: 11500,
    tagline: "Genuine EVE Grade-A+ LF100LA 102Ah prismatic cell — our most-shipped product.",
    ...
    description:
      "Genuine EVE 3.2V 102Ah Grade-A+ lithium iron phosphate (LiFePO4) prismatic cell — direct from EVE Energy. Used to build lithium batteries.",
    image: "assets/cells/cell-hero.webp",
    specs: [
      ["Chemistry", "Lithium iron phosphate (LiFePO4)"],
      ["Nominal voltage", "3.2V"],
      ["Capacity", "102Ah (326Wh) at 0.5C, 25°C"],
