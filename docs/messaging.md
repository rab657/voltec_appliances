...
| Prices | website (**Rs 9,400/cell** — clearance rate from 2026-08-11) | **any Meta ad creative** (standing rule 2026-07-27). Private negotiating ladder: not recorded in this repo (see gitignored memory.md). (user: "goal is to sell as quickly as possible… the longer they stay, the more it costs me") |
