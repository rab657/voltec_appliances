...
| Prices | website list is **Rs 9,500/cell** (set by Raheel 2026-09-21, down from 9,800) — it does not track the private deal rate | **any Meta ad creative** (standing rule 2026-07-27). ⚠️ **Never sweep the private WhatsApp deal rate onto the site** — the public list price is set deliberately and separately (user, 2026-08-11). It was moved 9,800 → 9,500 by explicit instruction on 2026-09-21; ask before changing it again. The private negotiating ladder is **not recorded in this repo** — it lives in the gitignored `memory.md` (moved 2026-09-21: this file is committed to a PUBLIC GitHub repo that appears in search results). |
