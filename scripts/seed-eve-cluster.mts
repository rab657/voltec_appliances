...
//    dominant. Evolta lists 100Ah around Rs 12,000 — Voltec is Rs 9,400.
...
const pillar = {
  ...
  metaDescription:
    "Genuine EVE LiFePO4 cells in Pakistan: LF100LA at Rs 9,400 per cell, sold by the carton of 8. Grades explained, QR verification, and 24V/48V pack sizing.",
  keywords: [
  ...
  takeaways: [
    ...
    "Voltec stocks EVE LF100LA (3.2V 100Ah) at Rs 9,400 per cell, sold by the carton of 8. One carton = a 24V bank; two = 48V.",
...
<p>Voltec sells the <strong>EVE LF100LA at Rs 9,400 per cell</strong>, by the carton of 8. We do not break cartons. Local listings for comparable 100–105Ah cells sit around Rs 11,000–12,000, so the carton price is competitive — but price alone is a bad way to choose.</p>
...
<p>Cells are Rs 9,400 each, carton of 8, delivered across Punjab, KPK and Gilgit-Baltistan, or collected from our Abid Market showroom in Lahore. See the <a href="/products/vt-eve-lf100">LF100LA product page</a> or message us on WhatsApp for dealer rates on multiple cartons.</p>`,
  faqs: [
    { q: "What is the price of EVE cells in Pakistan?",
      a: "Voltec sells the EVE LF100LA 3.2V 100Ah cell at Rs 9,400 per cell, sold by the carton of 8 (Rs 75,200 per carton). Dealer rates are available on multiple cartons — ask on WhatsApp. Comparable 100–105Ah cells are commonly listed locally at Rs 11,000–12,000." },
...
<p>EVE LF100LA cells are Rs 9,400 each, sold by the carton of 8, with the batch test report included and the QR codes available for you to check before payment. Delivery across Punjab, KPK and Gilgit-Baltistan, or collection from our Abid Market showroom in Lahore.</p>
...
const pricing = {
  ...
  readTime: 7,
  excerpt:
    "Rs 9,400 per cell, carton of 8. Here is what a complete 24V and 48V build actually costs once you add the BMS and busbars — and when buying a finished pack makes more sense.",
  metaTitle: "EVE LF100LA Price in Pakistan (2026) — 24V & 48V Pack Cost Breakdown",
  metaDescription:
    "EVE LF100LA 3.2V 100Ah at Rs 9,400 per cell, carton of 8. Full 24V (2.56 kWh) and 48V (5.12 kWh) pack sizing, what else you need, and total build cost.",
  keywords: [
  ...
  takeaways: [
    "EVE LF100LA is Rs 9,400 per cell, sold by the carton of 8 — Rs 75,200 per carton.",
...
<h2>Cell price</h2>
<p><strong>EVE LF100LA, 3.2V 100Ah: Rs 9,400 per cell.</strong> Sold by the carton of 8, so Rs 75,200 per carton. We do not break cartons — a pack has to be built from cells of the same batch, and splitting cartons is how mismatched banks get made. Dealer rates apply on multiple cartons; ask on WhatsApp.</p>
...
<tbody>
<tr><td>8S</td><td>8</td><td>1</td><td>25.6V ("24V")</td><td>2.56 kWh</td><td>Rs 75,200</td></tr>
<tr><td>16S</td><td>16</td><td>2</td><td>51.2V ("48V")</td><td>5.12 kWh</td><td>Rs 150,400</td></tr>
<tr><td>16S2P</td><td>32</td><td>4</td><td>51.2V ("48V")</td><td>10.24 kWh</td><td>Rs 300,800</td></tr>
<tr><td>16S3P</td><td>48</td><td>6</td><td>51.2V ("48V")</td><td>15.36 kWh</td><td>Rs 451,200</td></tr>
</tbody></table></div>
...
<p>In practice the cells come to roughly 80–85% of a self-built pack. So a 48V 5.12 kWh build starts around Rs 150,400 in cells, with the balance of materials on top of that depending on the BMS you choose.</p>
...
<p>Current stock and specifications are on the <a href="/products/vt-eve-lf100">LF100LA product page</a>. Delivery across Punjab, KPK and Gilgit-Baltistan, or collect in Lahore.</p>`,
  faqs: [
    { q: "What is the price of an EVE LF100LA cell in Pakistan?",
      a: "Rs 9,400 per cell, sold by the carton of 8, which is Rs 75,200 per carton. Dealer rates are available on multiple cartons. Nuts and copper busbars are supplied with the cells." },
    { q: "How much does a 48V 5kWh lithium battery cost to build?",
      a: "A 16S 48V pack at 5.12 kWh needs 16 EVE LF100LA cells — two cartons, so about Rs 150,400 in cells. Cells are roughly 80–85% of a build, so add a suitably sized BMS, compression end plates and banding, an enclosure, wiring and a main fuse on top." },
